      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        <div className="col-span-2">
          <div>
            ...
            Make a statement this summer with the Lasting New Bag from Summer Vibes. Shop now and experience the perfect blend of durability, style, and functionality for your sunny escapades!"
            </p>
          </div>
        </div>
